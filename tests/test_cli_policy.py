...
def test_default_cli_uses_current_policy_and_matches_direct_engine(monkeypatch, capsys, text):
    monkeypatch.chdir(ROOT)
    policy = load_policy(ROOT / "policies" / "triage_policy.v3.json")
    assert DEFAULT_POLICY == "policies/triage_policy.v3.json"
